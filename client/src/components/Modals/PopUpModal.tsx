...
interface PropsCross {
    click: Dispatch<SetStateAction<boolean>> | undefined
}
const Cross: React.FunctionComponent<PropsCross> = ({
    click
}) => {
    return (
        <svg onClick={() => {
            ...
            click(false);
        }} className={styles.cross} viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
